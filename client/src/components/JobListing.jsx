  ...
  return (
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
      ...
      <section className="w-full lg:w-3/4 text-gray-800 max-lg:px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 xl:grid-col-4 gap-4">
          {filteredJobs
              ...
              (__, index) => (
                <a key={index} href="#job-list">
                  <button
                    ...
                    className={`w-10 h-10 cursor-pointer flex justify-center items-center border border-gray-300 rounded ${
                      currentPage === index + 1
